    ...
    if not options.quiet:
        ...
        if lenres > 0:
            ...
            for k in sipvicious.resultauth.keys():
                logging.info("============================================")
                logging.info("Starting Extension cracker for IP: " + host + " to extension " + k)
                logging.info("============================================")
                os.system("python svcrack.py  -v "+ host +" -u " + k )
                os.system("python svcrack.py  -v -d parole.txt "+ host +" -u " + k )
        else:
